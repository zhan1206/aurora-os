...
# FIXED (v4.3.3): MOD-005 — Module build infrastructure
# Module targets: mod_sample.ko
# Build: $(CC) $(CFLAGS) -fPIC -shared -nostdlib -o mod_sample.ko userspace/mod_sample.c
